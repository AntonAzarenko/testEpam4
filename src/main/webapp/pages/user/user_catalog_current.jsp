...
<div class="container">
    <div class="dws-menu-two">
        ...
        <ul class="dws-ui-two">
            ...
            <li class="dws-li-two">
                <a href="/userPage?action=show&periodicalId=<c:out value="${periodicals.id}"/>">${periodicals.title}</a></li>
            </c:forEach>
        </ul>
...
<div class="container_two">
    ...
    <a href="/userPage?action=redirectsubscribe&periodicalId=<c:out value="${periodical.id}"/>">

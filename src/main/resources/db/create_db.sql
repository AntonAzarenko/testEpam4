...
USE mydb;
INSERT INTO catalog_periodicals (title, discription, publisher, output_frequency, per_index, age_limit,archive, price) VALUES
  ('Вяселка', 'Развлекательный журнал', 'unknow', '6', '65234', '6','0', '1.35'),
  ('СпидИнфо', 'Еженедельная газета', 'unknow', '12', '22354', '18', '0','3.25'),
  ('Вечерний Витебск', 'Еженедельный обозреватель', 'unknow', '48', '32658', '12','0', '1.47'),
  ('Секретные исследования', 'фантастическая газета', 'unknow', '24', '58986', '10', '0','1.29'),
  ('Камсомолка', 'Еженедельная газета', 'unknow', '12', '45896', '15', '0','2.85'),
  ('Аргументы и Факты', 'Еженедельная газета', 'unknow', '24', '58745', '15','0' ,'3.85'),
